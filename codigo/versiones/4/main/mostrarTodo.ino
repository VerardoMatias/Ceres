void mostrarTodo(float temp1, float temp2, float hum1, float hum2) {
  ...
  String vegeConsola = (String) "VEGE: TEMP " + temp1 + "C // HUM %" + hum1Resta;
  Serial.println(vegeConsola);

  String floraConsola = (String) "FLORA: TEMP " + temp2 + "C // HUM %" + hum2Resta;
  Serial.println(floraConsola);
